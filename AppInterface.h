...
#ifndef APPINTERFACE_INCLUDED
#define	APPINTERFACE_INCLUDED
...
extern "C"{
#endif
   void c_runApp(char *, int *, int *, int *, MPI_Fint *, bool *, bool *, int *,
            int * nx, int * ny, int * nz, int * n_comb, bool * isRealCall);
   void visualizeField(int * proc_x, int * proc_y, int * proc_z, MPI_Fint *,
            int * nx, int * ny, int * nz,
            int * app_size, double * app_field);
   void c_get_app_field(int * ndims, double * fi_1d, double * fi_2d, double * fi_3d,
...
void setParameters(char * parInDir, int n_procs_x_dim, int n_procs_y_dim, int n_procs_z_dim, 
    ...
    // Running full grid APP for whole timesteps
